      ...
      _export("MahjongGame", MahjongGame = (_dec = ccclass('MahjongGame'), _dec2 = property({
        ...
        dealTiles() {
          ...
          for (var i = 0; i < 14; i++) {
            ...
            var tileData = this.allTiles[i];
            var sprite = tileNode.getComponent(Sprite);
        ...
        onTileSelected(event) {
          var tileNode = event.target;
          var highlight = tileNode.getChildByName('SelectHighlight');
        ...
        checkTriplet() {
          var tilesData = this.selectedTiles.map(tile => {
            return;
          });
