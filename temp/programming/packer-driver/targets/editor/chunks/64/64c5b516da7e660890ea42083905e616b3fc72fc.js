      ...
      _export("GameManager", GameManager = (_dec = ccclass('GameManager'), _dec2 = property(Prefab), _dec3 = property([SpriteFrame]), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Prefab), _dec(_class = (_class2 = class GameManager extends Component {
        ...
        initTiles() {
          ...
          for (let i = 0; i < 136; i++) {
            ...
            let tileScript = tile.getComponent(_crd && MahjongTile === void 0 ? (_reportPossibleCrUseOfMahjongTile({
              error: Error()
        ...
        spawnMonster() {
          const monster = instantiate(this.monsterPrefab); // if (monster) {
...
//# sourceMappingURL=64c5b516da7e660890ea42083905e616b3fc72fc.js.map